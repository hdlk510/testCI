...
[2.5.8 k_acodec_set_gain_hpoutr](#k_acodec_set_gain_hpoutr)
...
[3.1.1 k_audio_type](#k_audio_type)
...
### <a id="kd_mpi_aenc_release_stream">2.3.7 kd_mpi_aenc_release_stream</a>
-   【描述】
...
### <a id="k_acodec_set_gain_micl">2.5.1 k_acodec_set_gain_micl</a>
-   【描述】
...
### <a id="kd_mapi_aenc_init">2.6.1 kd_mapi_aenc_init</a>
-   【描述】
...
### <a id="kd_mapi_adec_init">2.7.1 kd_mapi_adec_init</a>
-   【描述】
...
### <a id="k_audio_frame">3.1.14 k_audio_frame</a>
【说明】
...
### <a id="k_audio_anr_cfg">3.1.15 k_audio_anr_cfg</a>
【说明】
...
### <a id="k_audio_agc_cfg">3.1.16 k_audio_agc_cfg</a>
【说明】
...
### <a id="k_ai_vqe_cfg">3.1.17 k_ai_vqe_cfg</a>
【说明】
...
[**k_audio_anr_cfg**](#**k_audio_anr_cfg**)

[**k_audio_agc_cfg**](#**k_audio_agc_cfg**)
...
### <a id="k_payload_type">3.2.1 k_payload_type</a>
【说明】
...
### <a id="k_aenc_encoder">3.2.2 k_aenc_encoder</a>
【说明】
...
### <a id="k_aenc_chn_attr">3.2.3 k_aenc_chn_attr</a>
【说明】
...
**k_u32 buf_size; /\* buf size[2\~**[**K_MAX_AUDIO_FRAME_NUM**](#K_MAX_AUDIO_FRAME_NUM)**] \*/**
...
| buf_size            | 音频编码缓存大小。  取值范围：[2, [**K_MAX_AUDIO_FRAME_NUM**](#K_MAX_AUDIO_FRAME_NUM)]，以帧为  单位。 |
...
### <a id="AENC_MAX_CHN_NUMS">3.2.4 AENC_MAX_CHN_NUMS</a>
【说明】
...
### <a id="K_MAX_ENCODER_NAME_LEN">3.2.5 K_MAX_ENCODER_NAME_LEN</a>
【说明】
...
### <a id="k_aenc_chn">3.2.6 k_aenc_chn</a>
【说明】
...
### <a id="k_audio_stream">3.2.7 k_audio_stream</a>
【说明】
...
### <a id="k_adec_chn_attr">3.2.8 k_adec_chn_attr</a>
【说明】
...
### <a id="k_adec_decoder">3.2.9 k_adec_decoder</a>
【说明】
...
**k_char name[**[**K_MAX_DECODER_NAME_LEN**](#K_MAX_DECODER_NAME_LEN)**];**
...
### <a id="K_MAX_DECODER_NAME_LEN">3.2.10 K_MAX_DECODER_NAME_LEN</a>
【说明】
...
### <a id="ADEC_MAX_CHN_NUMS">3.2.11 ADEC_MAX_CHN_NUMS</a>
【说明】
...
## <a id="MAPI">3.3 MAPI</a>
音频mapi相关数据类型、数据结构定义如下

[k_handle](#k_handle)

### <a id="k_handle">3.3.1 k_handle</a>
【说明】
...
# <a id="错误码">4. 错误码</a>
## <a id="音频输入API错误码">4.1 音频输入API 错误码</a>
| 错误代码 | 宏定义                 | 描述                        |
|----------|------------------------|-----------------------------|
...
## <a id="音频输出API错误码">4.2 音频输出API 错误码</a>
| 错误代码 | 宏定义                  | 描述                      |
|----------|-------------------------|---------------------------|
